...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" OnClientClick="return confirm('Are you sure?');" Text="Delete" />
        <asp:Button ID="Button3" runat="server" Text="Drop&amp;Create" OnClick="Button3_Click" />
        <br />
        <br />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource2" EmptyDataText="沒有資料錄可顯示。" ForeColor="Black" GridLines="Vertical" OnRowDataBound="GridView1_RowDataBound" OnRowUpdating="GridView1_RowUpdating" PageSize="5">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="score" SortExpression="score">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("score", "{0:F2}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="picture" SortExpression="shape">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("shape") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <ItemTemplate>
